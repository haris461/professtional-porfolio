...
<html lang="en">
  <head>
    <title>haris farooq Portfolio</title>
    <meta charset="utf-8">
...
.zoom-effect:hover {
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar ftco-navbar-light site-navbar-target" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">haris farooq</a>
	       ...
	       <div class="slider-item ">
	         ...
	         <div class="container">
	          <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
	          	<div class="one-third js-fullheight order-md-last img" style="background-image:url(images/bg-1.jfif);">
	          	 <div class="overlay"></div>
	          	</div>
		          <div class="one-forth d-flex  align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text">
		          		<span class="subheading">Hello!</span>
			            <h1 class="mb-4 mt-3">I'm <span>haris farooq</span></h1>
						...
						<br>
						<br>
			            <h2>love the web devlopment</h2>
						<!-- <h2 class="d-flex" style="margin-bottom: 0">With over 5 years of experience</h2> -->
						<!-- <br> -->
			            <p><a href="https://www.youtube.com/" class="btn btn-primary py-3 px-4">YouTube</a> 
							<a href="https://github.com/haris461?tab=repositories" class="btn btn-white btn-outline-white py-3 px-4">My works</a></p>
		            </div>
		          </div>
	        	</div>
	        </div>
							...
							<div class="overlay">
								<div class="row">
									<div class="col-sm-6 col-md-5">
									  <div class="about-img">
										<img src="images/about-me.jfif" class="img-fluid rounded b-shadow-a" alt="">
									  </div>
									</div>
									<!-- Details next to profile image -->
									<div class="col-sm-6 col-md-7">
									  <div class="about-info">
										<p><span class="title-s">Name: </span> <span>haris farooq</span></p>
		
										<p><span class="title-s">Experience: </span> <span>doing basics web projects</span></p>
										<p><span class="title-s">Address: </span> <span>faisalabad, pakistan</span></p>
									  </div>
									</div>
								  </div>
								...
								<div class="skill-mf">
									...
									<span>PYTHON</span> <span class="pull-right">25%</span> 
									<div class="progress">
										<div class="progress-bar" role="progressbar" style="width: 25%" aria-valuenow="85" aria-valuemin="0"
											aria-valuemax="100"></div>
									</div>
									
									<span>Data base</span> <span class="pull-right">68%</span>
									<div class="progress">
										<div class="progress-bar" role="progressbar" style="width: 68%" aria-valuenow="90" aria-valuemin="0"
											aria-valuemax="100"></div>
									</div>
					...
					<div class="col-md-6 col-lg-7 pl-lg-5 pb-5">
						<div class="row justify-content-start pb-3">
							<div class="col-md-12 heading-section ftco-animate">
								...
								<p>i am haris farooq i am student and the developer in web Development and  i dono many project 
									for the organization  i also many fields of computer science</p>
							
								<ul class="about-info mt-4 px-md-0 px-2">
									<li class="d-flex"><span>Profile:</span> <span>web Development&amp; Analytics</span></li>
									<li class="d-flex"><span>Domain:</span> <span> computer science, mathmatical model &amp; object oriented programming</span></li>
									...
									<li class="d-flex"><span>BI Tools:</span> <span>Microsoft Power BI, Looker &amp; visua studio code</span></li>
									<li class="d-flex"><span>Other Skills:</span> <span>Cloud, PySpark, Excel, Git, Github &amp; SEO</span></li>
									<li class="d-flex"><span>Interest:</span> <span>Traveling, watching movies , playing games</span></li>
						...
						<div class="counter-wrap ftco-animate d-flex mt-md-3">
							<div class="text">
								<p class="mb-4">
									<span class="number" data-number="12">0</span> <span>+</span>
									<span>&nbsp; Projects completed</span>
								</p>
								<p><a href="https://github.com/haris461?tab=repositories" class="btn btn-primary py-3 px-3">Github</a></p>
							</div>
						</div>
					</div>
				</div>
    ...
    <section class="ftco-section ftco-no-pb" id="resume-section">
    	<div class="container">
          ...
          <div class="col-md-10 heading-section text-center ftco-animate">
            ...
            <p> i done my degree of bscs from fast nuces chinot i have done many small project during my degree i have dono many c++ projects and data base managment project ande web projects</p>
          </div>
        </div>
		...
		<div class="row">
				<div class="col-md-6">
					<div class="resume-wrap ftco-animate">
						...
						<h2>web developer</h2>
						<span class="position">student project manager</span>
						<p class="mt-4">i manage many student project in my university time  i have also learn many skills like how to do work in the team 
							<ul>
								<li>i have dono many projects i c++ and takes the tutorial from you tube also and learn how to do small project</li>
								<li> i have dono the project in c# which like like c++ i have also make the projects in it </li>
				...
				<div class="col-md-6">
					<div class="resume-wrap ftco-animate">
						...
						<h2>web developer</h2>
						<span class="position">head of supervisor</span>
						<p class="mt-4">head of supervisor is used to manage the worker that are working in the university and the labs of university. 
							<ul>
		...
		<br>
			...
			<div class="row">
    			<div class="col-md-6">
    				<div class="resume-wrap ftco-animate">
    					<span class="date">2021-2024 present</span>
    					<h2>Bachelor of computer science</h2>
    					<span class="position">FAST-NUCES University</span>
    					<p class="mt-4">Grade: cgpa 3.01 completed the degree.</p>
    				</div>
    			</div>
    			...
    			<div class="col-md-6">
    				<div class="resume-wrap ftco-animate">
    					...
    					<h2>THE high degree Schooling  system</h2>
    					<span class="position">THE Educators School system</span>
			...
			<!-- <div class="container"> -->
				<div class="row justify-content-center">
					<div class="col-md-7 ftco-animate text-center">
						...
						<br>
						<p><a href="https://github.com/haris461?tab=repositories" class="btn btn-primary py-3 px-5">GitHub</a></p>
						</div>
					</div>
				</div>
			<!-- </div> -->
        ...
        <div class="row d-flex contact-info mb-5">
          ...
          <div class="col-md-6 col-lg-3 d-flex ftco-animate">
          	<div class="align-self-stretch box p-4 text-center">
	            ...
	            <p><a href="tel://0101010101">+ 03412600245</a></p>
	          </div>
          </div>
          <div class="col-md-6 col-lg-3 d-flex ftco-animate">
          	<div class="align-self-stretch box p-4 text-center">
	            ...
	            <p><a href="mailto:info@yoursite.com">harisfarooq402@gmail.com</a></p>
	          </div>
          </div>
          <div class="col-md-6 col-lg-3 d-flex ftco-animate">
          	<div class="align-self-stretch box p-4 text-center">
				...
				<br>
					<ul class="ftco-footer-social list-unstyled d-flex justify-content-center align-items-center mb-0">
					 ...
					 <!-- <li class="ftco-animate"><a href="https://www.linkedin.com/in/rishabhnmishra/"><span class="icon-linkedin"></span></a></li>!-->  
					  <li class="ftco-animate"><a href="https://github.com/haris461?tab=repositories"><span class="icon-github"></span></a></li>
					  <li class="ftco-animate"><a href="https://www.linkedin.com/feed/?trk=guest_homepage-basic_google-one-tap-submit"><span class="icon-linkedin"></span></a></li>
	...
	Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This Portfolio is made with <i class="icon-heart color-red" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a>
